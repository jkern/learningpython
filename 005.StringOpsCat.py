...
l = "lo"	# Let's make another conatiner. Note: You do not need to declare the variable first!


word = h + l	# This process is called concatenation (concat for short), this would be like saying '1 + 1 = 11' or 'a + a = aa'
		# We are not adding, we are combining
		# Notice here that we can store variables inside one another

print word, "World!" 	# What are we doing here? We have just combined a string, and a variable. Sweet!
